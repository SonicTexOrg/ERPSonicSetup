...
// ---    Tue Jun 13 11:24:04 PKT 2023
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class UomEOImpl extends EntityImpl {
    /**
    ...
    /**
     * Gets the attribute value for UomName, using the alias name UomName.
     * @return the value of UomName
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for UomName.
     ...
     */
    public static Key createPrimaryKey(Number uomId) {
        return new Key(new Object[] { uomId });
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("STP.model.eo.UomEO");
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        SequenceImpl seq = new SequenceImpl("UOM_S", getDBTransaction());
        setUomId(seq.getSequenceNumber());
